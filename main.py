...
class IndexCreation(MouseScreen):
    ...
    def exec_formula(self, *args):
        ...
        self.rev_id_conn = {'IA': 'Surface area (sq. km)'}
        ...
        self.rev_country_dict = {'AGO': 'Angola', 'DZA': 'Algeria', 'EGY': 'Egypt, Arab Rep.', 'BGD': 'Bangladesh', 'NER': 'Niger', 'LIC': 'Low income', 'MIC': 'Middle income', 'NAM': 'Namibia', 'VEN': 'Venezuela, RB', 'BGR': 'Bulgaria', 'BOL': 'Bolivia', 'GHA': 'Ghana', 'NAF': 'North Africa', 'PAK': 'Pakistan', 'WLD': 'World', 'CPV': 'Cabo Verde', 'ROU': 'Romania', 'JOR': 'Jordan', 'LBR': 'Liberia', 'LBY': 'Libya', 'MYS': 'Malaysia', 'PRI': 'Puerto Rico', 'SXM': 'Sint Maarten (Dutch part)', 'PRK': 'Korea, Dem. Rep.', 'PSE': 'West Bank and Gaza', 'TZA': 'Tanzania', 'BWA': 'Botswana', 'KHM': 'Cambodia', 'NIC': 'Nicaragua', 'SAS': 'South Asia', 'SXZ': 'Sub-Saharan Africa excluding South Africa', 'XZN': 'Sub-Saharan Africa excluding South Africa and Nigeria', 'PRY': 'Paraguay', 'HKG': 'Hong Kong SAR, China', 'SAU': 'Saudi Arabia', 'LBN': 'Lebanon', 'SVN': 'Slovenia', 'BFA': 'Burkina Faso', 'CHE': 'Switzerland', 'LMY': 'Low & middle income', 'MRT': 'Mauritania', 'CHI': 'Channel Islands', 'HRV': 'Croatia', 'CHL': 'Chile', 'CHN': 'China', 'KNA': 'St. Kitts and Nevis', 'JAM': 'Jamaica', 'SMR': 'San Marino', 'DJI': 'Djibouti', 'GIN': 'Guinea', 'FIN': 'Finland', 'URY': 'Uruguay', 'THA': 'Thailand', 'SYC': 'Seychelles', 'NPL': 'Nepal', 'LAO': 'Lao PDR', 'YEM': 'Yemen, Rep.', 'PHL': 'Philippines', 'ZAF': 'South Africa', 'KIR': 'Kiribati', 'NOC': 'High income: nonOECD', 'LAC': 'Latin America & Caribbean (developing only)', 'VIR': 'Virgin Islands (U.S.)', 'SYR': 'Syrian Arab Republic', 'MAC': 'Macao SAR, China', 'LIE': 'Liechtenstein', 'MAF': 'St. Martin (French part)', 'MLT': 'Malta', 'KAZ': 'Kazakhstan', 'TCA': 'Turks and Caicos Islands', 'PYF': 'French Polynesia', 'SUR': 'Suriname', 'DMA': 'Dominica', 'KSV': 'Kosovo', 'BEN': 'Benin', 'NGA': 'Nigeria', 'BEL': 'Belgium', 'TGO': 'Togo', 'CME': 'Middle East and North Africa (IFC classification)', 'DEU': 'Germany', 'GUM': 'Guam', 'LKA': 'Sri Lanka', 'EMU': 'Euro area', 'GBR': 'United Kingdom', 'GUY': 'Guyana', 'CRI': 'Costa Rica', 'CMR': 'Cameroon', 'LDC': 'Least developed countries: UN classification', 'MAR': 'Morocco', 'CEB': 'Central Europe and the Baltics', 'CEA': 'East Asia and the Pacific (IFC classification)', 'MNP': 'Northern Mariana Islands', 'LSO': 'Lesotho', 'HUN': 'Hungary', 'TKM': 'Turkmenistan', 'VCT': 'St. Vincent and the Grenadines', 'CEU': 'Europe and Central Asia (IFC classification)', 'TTO': 'Trinidad and Tobago', 'NLD': 'Netherlands', 'BMU': 'Bermuda', 'MNA': 'Middle East & North Africa (developing only)', 'TCD': 'Chad', 'GEO': 'Georgia', 'MNE': 'Montenegro', 'MNG': 'Mongolia', 'MHL': 'Marshall Islands', 'BLZ': 'Belize', 'BDI': 'Burundi', 'MMR': 'Myanmar', 'AFG': 'Afghanistan', 'CSA': 'South Asia (IFC classification)', 'BLR': 'Belarus', 'GRD': 'Grenada', 'GRC': 'Greece', 'OED': 'OECD members', 'GRL': 'Greenland', 'CSS': 'Caribbean small states', 'AND': 'Andorra', 'MOZ': 'Mozambique', 'INX': 'Not classified', 'OSS': 'Other small states', 'SST': 'Small states', 'TJK': 'Tajikistan', 'HTI': 'Haiti', 'MEX': 'Mexico', 'ZWE': 'Zimbabwe', 'ANR': 'Andean Region', 'LCA': 'St. Lucia', 'IND': 'India', 'LVA': 'Latvia', 'BTN': 'Bhutan', 'SSA': 'Sub-Saharan Africa (developing only)', 'VNM': 'Vietnam', 'NOR': 'Norway', 'CZE': 'Czech Republic', 'ATG': 'Antigua and Barbuda', 'FJI': 'Fiji', 'HND': 'Honduras', 'MUS': 'Mauritius', 'DOM': 'Dominican Republic', 'LUX': 'Luxembourg', 'ISR': 'Israel', 'FSM': 'Micronesia, Fed. Sts.', 'PER': 'Peru', 'IDN': 'Indonesia', 'VUT': 'Vanuatu', 'MKD': 'Macedonia, FYR', 'COD': 'Congo, Dem. Rep.', 'COG': 'Congo, Rep.', 'ISL': 'Iceland', 'ETH': 'Ethiopia', 'COM': 'Comoros', 'COL': 'Colombia', 'TLS': 'Timor-Leste', 'FCS': 'Fragile and conflict affected situations', 'ECA': 'Europe & Central Asia (developing only)', 'PRT': 'Portugal', 'MDA': 'Moldova', 'STP': 'Sao Tome and Principe', 'MDG': 'Madagascar', 'MDE': 'Middle East (developing only)', 'ECU': 'Ecuador', 'ECS': 'Europe & Central Asia (all income levels)', 'AFR': 'Africa', 'SEN': 'Senegal', 'MDV': 'Maldives', 'ASM': 'American Samoa', 'CUW': 'Curacao', 'FRA': 'France', 'LTU': 'Lithuania', 'RWA': 'Rwanda', 'ZMB': 'Zambia', 'GMB': 'Gambia, The', 'SSD': 'South Sudan', 'FRO': 'Faeroe Islands', 'CLA': 'Latin America and the Caribbean (IFC classification)', 'DNK': 'Denmark', 'IMN': 'Isle of Man', 'AUS': 'Australia', 'AUT': 'Austria', 'EUU': 'European Union', 'LCR': 'Latin America and the Caribbean', 'PSS': 'Pacific island small states', 'PLW': 'Palau', 'KEN': 'Kenya', 'MEA': 'Middle East & North Africa (all income levels)', 'WSM': 'Samoa', 'TUR': 'Turkey', 'ALB': 'Albania', 'OMN': 'Oman', 'TUV': 'Tuvalu', 'ITA': 'Italy', 'BRN': 'Brunei Darussalam', 'TUN': 'Tunisia', 'OEC': 'High income: OECD', 'RUS': 'Russian Federation', 'LMC': 'Lower middle income', 'BRB': 'Barbados', 'BRA': 'Brazil', 'CIV': "Cote d'Ivoire", 'SRB': 'Serbia', 'UMC': 'Upper middle income', 'GNQ': 'Equatorial Guinea', 'USA': 'United States', 'QAT': 'Qatar', 'SWE': 'Sweden', 'AZE': 'Azerbaijan', 'GNB': 'Guinea-Bissau', 'SWZ': 'Swaziland', 'TON': 'Tonga', 'CAN': 'Canada', 'UKR': 'Ukraine', 'CAA': 'Sub-Saharan Africa (IFC classification)', 'KOR': 'Korea, Rep.', 'CAF': 'Central African Republic', 'SVK': 'Slovak Republic', 'CYP': 'Cyprus', 'BIH': 'Bosnia and Herzegovina', 'SGP': 'Singapore', 'SOM': 'Somalia', 'UZB': 'Uzbekistan', 'ERI': 'Eritrea', 'POL': 'Poland', 'HIC': 'High income', 'KWT': 'Kuwait', 'EAP': 'East Asia & Pacific (developing only)', 'EAS': 'East Asia & Pacific (all income levels)', 'GAB': 'Gabon', 'CYM': 'Cayman Islands', 'EST': 'Estonia', 'MWI': 'Malawi', 'ESP': 'Spain', 'IRQ': 'Iraq', 'SLV': 'El Salvador', 'MLI': 'Mali', 'GTM': 'Guatemala', 'LCN': 'Latin America & Caribbean (all income levels)', 'IRL': 'Ireland', 'IRN': 'Iran, Islamic Rep.', 'ABW': 'Aruba', 'HPC': 'Heavily indebted poor countries (HIPC)', 'SLE': 'Sierra Leone', 'PAN': 'Panama', 'SDN': 'Sudan', 'SLB': 'Solomon Islands', 'NZL': 'New Zealand', 'MCO': 'Monaco', 'SSF': 'Sub-Saharan Africa (all income levels)', 'JPN': 'Japan', 'NAC': 'North America', 'KGZ': 'Kyrgyz Republic', 'MCA': 'Central America', 'SCE': 'Southern Cone', 'ARB': 'Arab World', 'UGA': 'Uganda', 'NCL': 'New Caledonia', 'ARE': 'United Arab Emirates', 'ARG': 'Argentina', 'BHS': 'Bahamas, The', 'BHR': 'Bahrain', 'ARM': 'Armenia', 'PNG': 'Papua New Guinea', 'CUB': 'Cuba'}
        ...
        formula = ['self.indicator_var_eval("IA","Region","Year")', '/', 'self.indicator_var_eval("IA","MNG","Year")', '*', 'self.indicator_var_eval("IA","MNG","2014")', '-', 'self.indicator_var_eval("IA","Region","Year")', '+', 'math.fabs', '(', '-', '10', ')']
