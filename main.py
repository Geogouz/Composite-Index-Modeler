...
class IndexCreation(MouseScreen):
    ...
    def build_data_table(self, dt):
        ...
        if self.data_queue:
            ...
            if first_build:
                self.data_table_frame.opacity = 1
                # Build the first line and remove it from queue afterwards.
                for step, header in enumerate(self.year_row):
                    # Check if this is the 0.0 cell.
                    if header == "top_left_cell":
                        self.data_table.add_widget(Factory.TopLeftBox())
                    else:
                        ...
                        self.data_table.add_widget(head_box)
    ...
    def sort_data_manager(self, *args):
        print self, args[0].col, args[0].rev
        print len(self.data_view_now), self.data_view_now
        ...
        print len(self.data_view_now), len(self.data_queue)

        self.data_table_frame.opacity = 0
